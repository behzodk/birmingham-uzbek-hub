    ...
    <Layout>
      ...
      <section className="relative bg-primary overflow-hidden py-16 md:py-24">
        ...
        <div className="absolute inset-0 pointer-events-none">
          {/* Dome shapes */}
          <div
            className="absolute -top-12 md:-top-20 right-[10%] md:right-[15%] w-24 md:w-40 h-24 md:h-40 rounded-full border-[3px] md:border-[4px] border-primary-foreground/20 animate-spin-slow"
            style={{ animationDuration: "30s" }}
          />

          {/* Spinning star pattern */}
          <div
            className="absolute top-16 md:top-20 right-[25%] md:right-[30%] animate-spin-slow hidden sm:block"
          ...
          <div className="absolute bottom-16 md:bottom-24 right-[8%] md:right-[20%] animate-float">
            <div className="w-10 h-10 md:w-14 md:h-14 bg-secondary border-[3px] border-foreground shadow-[3px_3px_0px_0px_hsl(var(--foreground))]">
              <span className="flex items-center justify-center h-full text-lg md:text-2xl">
                🤝
              </span>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="font-body text-base md:text-xl text-primary-foreground/90 max-w-xl">
              The Silk Road once connected East and West; now Mehmonxona connects
              Uzbek hearts in Birmingham — sharing plov nights, playing sports
              together, exploring new places, and making memories as one family.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-4 md:mb-6">
                Our Mission : A Piece of Home on Campus
              </h2>
              <p className="font-body text-base md:text-lg text-muted-foreground mb-4">
                Miss the food? Miss the jokes? Miss the language? UzbekSoc is
                here to bring a piece of Uzbekistan to Birmingham.
              </p>
              <p className="font-body text-base md:text-lg text-muted-foreground mb-4">
                Our mission is to provide a break from the stress of exams and
                essays by bringing us together for the things that matter: good
                food, good conversation (gurung) and great company. We are here
                to keep our culture alive in our daily lives and to make sure
                you always have a place where you belong.
              </p>
              <p className="font-body text-base md:text-lg text-muted-foreground">
                One place where you don't have to explain your culture - you
                just live it.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              ...
              <div className="neo-card bg-primary p-4 md:p-6 text-center">
                ...
                <div className="font-body text-xs md:text-sm text-primary-foreground/80">
                  Big Family
                </div>
              </div>
            </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-8">
            <div className="neo-card bg-card p-6 md:p-8">
              ...
              <p className="font-body text-sm md:text-base text-muted-foreground">
                Whether it's dancing at Navruz or reflecting on Independence Day,
                we celebrate Uzbek identity together - with food made by loving
                hands, music from our heritage and traditions we're proud to
                share.
              </p>
            </div>
            ...
            <div className="neo-card bg-card p-6 md:p-8">
              ...
              <p className="font-body text-sm md:text-base text-muted-foreground">
                Traveling the UK side by side, hosting parties that feel like
                family reunions - we're united through the memories we build
                together.
              </p>
            </div>
            ...
            <div className="neo-card bg-card p-6 md:p-8 sm:col-span-2 md:col-span-1">
              ...
              <p className="font-body text-sm md:text-base text-muted-foreground">
                Stay active with us through weekly sports gatherings - badminton,
                football, tennis, you name it. Need teammates? Count on us,
                we've got the players and the energy!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="font-body text-lg text-secondary-foreground/80 mb-8">
              Joining the Uzbek Society is simple. Membership is available through
              the official Guild of Students website and costs £5 for the entire
              academic year.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              >
                <a
                  href="https://www.guildofstudents.com/studentgroups/societies/uzbeksociety/"
                  target="_blank"
            ...
            <div className="neo-card bg-card p-8">
              ...
              <div className="grid sm:grid-cols-3 gap-6">
                ...
                {/* LinkedIn */}
                <a
                  href="https://www.linkedin.com/company/uobuzbeksoc/?viewAsMember=true"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 hover:text-primary transition-colors"
                >
